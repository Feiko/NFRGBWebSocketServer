...
namespace NFEchoWebSocketServer
{
    public class Program
    {
        ...
        private static NeopixelChain s_neoPixel;
        ...
        public static void Main()
        {
            ...
            s_neoPixel = new NeopixelChain(27, 1);
            s_neoPixel.UpdateLed(255, 0, 0);
        ...
        private static void Ws_MessageReceived(object sender, System.Net.WebSockets.MessageReceivedEventArgs e)
        {
            ...
            {
                s_neoPixel.UpdateLed(e.Frame.Buffer[0], e.Frame.Buffer[1], e.Frame.Buffer[2]);
...
<script>
    ...
    ws.onmessage = function (evt) {{
        ...
        document.getElementById(""response"").innerHTML = Number(dv.getUint8(0));
    }};
